...
export default function AdminProductAdd() {
    ...
    images.map((img) => {
      return (
        <div>
          ...
          <button className='btn icon-trash bg-danger' name={img.id} onClick={handleRemove}></button>
        </div>
      )
    })
  ...
  return (
    ...
    <div className='row'>
      <div className='col-8'><form id='createProduct' onSubmit={handleSubmit}>
        ...
        <div className="form-group row">
          ...
          <div className="col-9">
            <textarea id="description" name="description" onChange={handleChange} cols={40} rows={2.5} className="form-control" defaultValue={""} />
          </div>
        </div>
        <div className="form-group row">
          <label htmlFor="detail" className="col-2 col-form-label" >Detail</label>
          <div className="col-9">
            <textarea id="detail" name="detail" onChange={handleChange} cols={40} rows={2} className="form-control" defaultValue={""} not required/>
          </div>
        </div>
        <div className="form-group row">
          <label htmlFor="price" className="col-2 col-form-label" >Price</label>
          <div className="col-9">
            <input id="price" name="price" type="number" className="form-control" onChange={handleChange} />
          </div>
        </div>
        <div className="form-group row">
